...
> **Current focus: v0.2.0 is staged as a *draft pre-release* on GitHub with its per-OS smoke tests closed (2026-05-26). Publishing is now **deliberately on hold** at the user's choice — the draft is ready to publish whenever they decide. Meanwhile, work proceeds on the chores list + deferred regressions.**
